...
engine = create_async_engine(settings.DATABASE_URL, echo=True, future=True, pool_size=10, max_overflow=20, pool_recycle=1800, connect_args={"statement_cache_size": 0})
