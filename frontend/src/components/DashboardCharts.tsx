...
const style = { backgroundColor: '#FFFFFF', borderColor: '#EAE8E3', borderRadius: '16px', color: '#1F1E1B', boxShadow: '0 10px 30px -10px rgba(0,0,0,0.08)', fontSize: '11px' };
    ...
    <div className="h-72 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 20 }}>
          ...
          <Tooltip cursor={{ fill: '#FAF9F5' }} contentStyle={style} />
      ...
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          <Pie data={severityData} cx="50%" cy="50%" innerRadius={60} outerRadius={80} paddingAngle={5} dataKey="value">
            {severityData.map((e, idx) => <Cell key={idx} fill={e.color} stroke="transparent" />)}
          </Pie>
